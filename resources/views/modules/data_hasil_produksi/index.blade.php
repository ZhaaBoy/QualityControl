...
@section('title', 'Data Hasil Produk')
...
@section('breadcrumb')
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Hasil Produk
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">Data Hasil Produk</li>
            </ul>
            <!--end::Breadcrumb-->
        </div>
        <!--end::Page title-->
...
@section('content')
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            @if (can('Data Hasil Produksi', 'create'))
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <a href="{{ route('data_hasil_produksi.create') }}" class="btn btn-primary">Add Data Hasil Produk</a>
                </div>
            @endif
            <!--end::Card toolbar-->
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="dataTable">
                ...
                <thead>
                    ...
                    <tr class="text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="text-start min-w-100p">Status Pre Order</th>
                        <th class="text-start min-w-100p">Tanggal Start Awal</th>
...
@push('script_processing')
    <script>
        function loadData() {
            ...
            let route = '{{ route('data_hasil_produksi') }}';
            initializeDataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'status_pre_order',
                        name: 'status_pre_order',
                        render: function(data, type, row) {
                            let status = row['status_pre_order'];
                            let badgeClass = '';
                            ...
                            switch (status) {
                                ...
                                default:
                                    badgeClass =
                                    'badge-light-secondary'; // abu-abu untuk nilai selain Open/Close
                            }
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete', function() {
                let id = $(this).attr('id');
                confirmAndDelete("{{ route('data_hasil_produksi.destroy') }}", id);
            });
        });
    </script>
@endpush
